...
# Don't have past year scores for fifth grade 
...
score_diff = function(var_interest){
  fifth_grade %>% 
    ...
    summarize(mean_math = mean(glmath_scr_p0), 
              ...
              perc_pop = n()/nrow(fifth_grade))
}

vars = colnames(fifth_grade)
...
numeric_fifth = fifth_grade %>% 
  select(where(is.numeric)) 

correlations = cor(numeric_fifth[, colnames(numeric_fifth) != 'glmath_scr_p0'], 
                   numeric_fifth$glmath_scr_p0)
...
# highly correlated!
cor(fifth_grade$enrfay_district, fifth_grade$enrfay_school)
...
# takes longer to decrease -- doesn't plateau at any one distinct number 

models_list[['model2']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + 
                                 (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model3']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model4']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 specialed_now + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model5']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 specialed_now + lep_now + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model6']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 specialed_now + lep_now + chronic_absentee_p0 + 
                                 (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model7']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                 (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model8']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                 chronic_absentee_m1 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model9']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                 specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                 chronic_absentee_m1 + age + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model10']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + 
                                  homeless_2yr + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model11']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + 
                                  homeless_2yr + attend_p0 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model12']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + homeless_2yr + 
                                  attend_p0 + transferred_out_m1 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model13']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + homeless_2yr + 
                                  attend_p0 + transferred_out_m1 + 
                                  transferred_out_p0 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model14']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + homeless_2yr + 
                                  attend_p0 + transferred_out_m1 + 
                                  transferred_out_p0 + attend_m1 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model14']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + homeless_2yr + 
                                  attend_p0 + transferred_out_m1 + 
                                  transferred_out_p0 + attend_m1 + 
                                  migrant_2yr + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model15']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + homeless_2yr + 
                                  attend_p0 + transferred_out_m1 + 
                                  transferred_out_p0 + attend_m1 + 
                                  migrant_2yr + persist_inferred_p0 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)

models_list[['model16']] = lmer(glmath_scr_p0 ~ glmath_scr_m1 + readng_scr_m1 + frl_2yr + 
                                  specialed_now + lep_now + chronic_absentee_p0 + enrfay_school + 
                                  chronic_absentee_m1 + age + homeless_2yr + 
                                  attend_p0 + transferred_out_m1 + 
                                  transferred_out_p0 + attend_m1 + 
                                  migrant_2yr + persist_inferred_p0 + 
                                  dropout_inferred_p0 + (1 | schoolid_nces_enroll_p0), data = fifth_grade)
